...
@Route(value = "customer-substring-search", layout = MainView.class)
@ViewController("CustomerSubstringSearch")
@ViewDescriptor("customer-substring-search.xml")
public class CustomerSubstringSearch extends StandardView {
